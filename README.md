...
1. Convert all references to `v0.9.8` to `v0.9.8`.
2. Run cargo update.
...
Ensure you have all relevant dependencies for building the repo. The latest work so far is pegged to `polkadot-v0.9.8` and `release-v0.9.8` branches of Substrate, Cumulus, and Polkadot respectively.
```
cargo build --release
