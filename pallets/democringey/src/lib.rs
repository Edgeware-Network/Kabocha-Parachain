...
pub mod pallet {
	...
	pub type PublicProps<T: Config> = StorageValue<_, Vec<(PropIndex, T::Hash, VoteThreshold, T::BlockNumber, T::AccountId)>, ValueQuery>;
	...
	impl<T: Config> Pallet<T> {
		...
		///
		/// Weight: `O(p)`
		#[pallet::weight(T::WeightInfo::propose_treasury_spend_simple_majority())]
		pub(crate) fn propose_treasury_spend_simple_majority(
			origin: OriginFor<T>,
